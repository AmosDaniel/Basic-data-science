...
side = int(input("Enter the side in cm of a square tile")) # length of square
num_square = int(input("Enter the number of square tiles available")) # number of square

max_size_length = int(num_square ** 0.5)

area_square = (max_size_length * side) ** 2

print(f"Area of the largest possible square is {area_square}sqcm")
